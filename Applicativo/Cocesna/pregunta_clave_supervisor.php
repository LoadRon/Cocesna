          ...
          <div class="card text-center" style="background-color: rgba(229, 228, 255, 0.2);">
              ...
              <div class="card-body">
                 <form action= "encuesta.php" method="POST">
                    <div name="superv" id="superv" class="form" align="center">
                        <div class="md-form" style="width: 500px " >
                          <input type="text" class="form-control white-text" name="txtUserHelp" id="txtUserHelp" 
                          value="<?php echo $_GET["UserH"] ?>" readonly>
                          <label for="txtUserHelp" class="white-text">Usuario al que esta ayudando</label>
                        </div>
                    </div>
                    <?php
                    //impresion de las categorias
                    categoria::GenerarPreguntaFiltroSupervisor($conexion); 
                    $supervisorMensaje="Encuesta Respondida por el Supervisor con Usuario: ".$_SESSION['nombre_usuario'];
                    ?>
                  
                    <a href="agradecimiento.php" class="btn btn-primary">SI</a>
                    <button type="submit" id="btn-cambioUsuario"  name="btn-cambioUsuario" class="btn btn-danger" onclick="EjecutarPEncuesta('<?php echo $supervisorMensaje ?>')">NO</button>
                </form>   
                </div>             
              </div>
